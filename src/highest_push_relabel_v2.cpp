...
highest_push_relabel_max_flow_v2::highest_push_relabel_max_flow_v2(GraphAdjacencyVector &G)
: Gf(G)
{
...
void highest_push_relabel_max_flow_v2::pushFlow(int u, vectorList::edge *e, int flow) {
...
void highest_push_relabel_max_flow_v2::relabel(int u, vectorList::edge e) {
